 ...
 */
public class PersistedArgumentAnswer<T, I> extends EchoArgumentAnswer<T> {

    private final IdGenerator<I> idGenerator;

    private final Field field;

    public PersistedArgumentAnswer(Class<T> targetClazz, IdGenerator<I> idGenerator) {
        this("id", targetClazz, idGenerator);
    }

    public PersistedArgumentAnswer(String fieldName, Class<T> targetClazz, IdGenerator<I> idGenerator) {
