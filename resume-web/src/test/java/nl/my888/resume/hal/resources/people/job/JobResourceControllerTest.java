...
public class JobResourceControllerTest extends MockMvcTest {
    ...
    public void testGetPersonJobs() throws Exception {
        Person person = persisted(createValidUser("testit"));
        ...
        Employment job1 = EmploymentFixtures.persisted(createValidJob(person, organization1));
        Employment job2 = EmploymentFixtures.persisted(createValidJob(person, organization2));
